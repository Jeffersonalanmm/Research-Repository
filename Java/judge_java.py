...
if not items:
    raise SystemExit("No .java submissions found under ROOT_DIR.")

print(f"Found {len(items)} total Java submissions.")

persona_judge = (
    "You are a highly analytical and impartial expert judge specialized in Java programming. "
    "Your goal is to perform Truth Inference in an adversarial context. "
    "You must analyze multiple Java implementations of the same task and classify each one "
...
You will be given one Java source code. Evaluate it independently.
...
### TASK: Please write your best implementation of {item['algo']} in Java.
