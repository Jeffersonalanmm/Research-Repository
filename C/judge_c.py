...
if not items:
    raise SystemExit("No .c submissions found under ROOT_DIR.")

print(f"Found {len(items)} total C submissions.")

persona_judge = (
    "You are a highly analytical and impartial expert judge specialized in C programming. "
    "Your goal is to perform Truth Inference in an adversarial context. "
    "You must analyze multiple C implementations of the same task and classify each one "
...
You will be given one C source code. Evaluate it independently.
...
### TASK: Please write your best implementation of {item['algo']} in C.
