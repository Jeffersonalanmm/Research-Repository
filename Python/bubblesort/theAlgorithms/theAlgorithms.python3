...
def main():
    ...
    for _ in range(num_iterations):
        ...
        # Ordena o array com bubble_sort_iterative
        bubble_sort_iterative(arr[:])  # Usamos [:] para passar uma cópia
        # Ordena o array com bubble_sort_recursive
        bubble_sort_recursive(arr[:])  # Usamos [:] para passar uma cópia
